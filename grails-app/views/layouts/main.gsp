<%@ page import="org.rainboyan.demo.module.LanguageModuleDescriptor" %>
<!doctype html>
            ...
            <ul class="nav navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                        <g:each var="lang" in="${applicationContext.pluginManager.getEnabledModuleDescriptorsByClass(LanguageModuleDescriptor)}">
